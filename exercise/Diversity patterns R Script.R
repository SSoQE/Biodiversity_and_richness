  ...
  ### BIODIVERSITY PATTERNS AND THEIR EXPLANATIONS IN MAMMALS
   ...
   ### if you are getting an error, manually set the coordinate system (see below)
   ### if you are still getting some issue, skip the levelplot and move to the next step below (plot (sprich~latit))
